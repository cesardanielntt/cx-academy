...
public class CustomerController {
    ...
    public  String create(CustomerForm customerForm, RedirectAttributes redirectAttributes) {
        if(customerForm.getName().isEmpty()){
            redirectAttributes.addFlashAttribute("error", "Nome do cliente é obrigatório!");
    ...
    public String editPage(@RequestParam Integer code, Model model, RedirectAttributes redirectAttributes) {
    ...
    public String delete(@PathVariable Integer id, Model model, RedirectAttributes redirectAttributes) {
        try {
            ...
            redirectAttributes.addFlashAttribute("error", "Error to delete Cutomer");
        }
        return "redirect:/customers";
    }
