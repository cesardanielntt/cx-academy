...
public class DefaultClientePopulator implements ClientePopulator {
    ...
    @Override
    public ClienteModel populateCliente(ClienteDTO clienteDTO) {
    ...
    @Override
    public ClienteDTO populateClienteDTO(ClienteModel clienteModel) {
        return modelMapperService.modelMapper().map(clienteModel, ClienteDTO.class);
    }
