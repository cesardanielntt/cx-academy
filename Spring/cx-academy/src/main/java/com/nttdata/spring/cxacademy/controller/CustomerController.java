...
public class CustomerController{
    ...
    public String create(CustomerForm customerForm, RedirectAttributes redirectAttributes){
        ...
        redirectAttributes.addFlashAttribute("Sucess", "Cliente cadastrado!");
        return "redirect:/customers";
    }

    @GetMapping(value = "/edit")
    public String editCustomer(@RequestParam(name = "code") Integer cod, Model model, RedirectAttributes redirectAttributes){
        CustomerData customer = customerFacade.getCustomerByCod(cod);
