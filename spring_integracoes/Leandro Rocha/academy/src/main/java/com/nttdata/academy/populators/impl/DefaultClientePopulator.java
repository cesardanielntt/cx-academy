...
public class DefaultClientePopulator implements ClientePopulator {
    ...
    private EnderecoModel populateEnderecoModel(EnderecoModel endereco) {
    ...
    private EnderecoDTO populateEnderecoDTO(EnderecoModel e) {
        return modelMapperService.modelMapper().map(e, EnderecoDTO.class);
    }
