...
@Component public class DefaultProductService implements ProductService {
    ...
    @Override public List<ProductModel> getAllProducts() { return productDao.findAll(); }
    @Override public void saveProduct(ProductModel product) {
        if(product != null) {
            productDao.save(product);
        }
    }

    @Override public ProductModel getProductByCode(Integer productCode) {
        if (productCode !=null){
    ...
    @Override public void deleteProduct(Integer productCode) {
